...
$ curl http://localhost:8080/cart -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im1hcmlhIiwic3ViIjoyLCJpYXQiOjE2ODA3MTMwODYsImV4cCI6MTY4MDc5OTQ4Nn0.IliEKp4gfdkY-EzSFzXCXFnw_fKvKjdW0jnFRptJ95w"
$ # result -> {"userId":2}
```
